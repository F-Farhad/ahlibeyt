<article class="bg-white flex flex-col shadow my-4">
    <!-- Article Image -->
    <a href="{{route('tag.showPost', [$tag, $post])}}" class="hover:opacity-75">
    ...
    <div class="bg-white flex flex-col justify-start p-6">
        ...
        <a href="{{route('tag.showPost', [$tag, $post])}}" class="text-3xl font-bold hover:text-gray-700">
            {{$post->title}}
        </a>
        ...
        <a href="{{route('tag.showPost', [$tag, $post])}}" class="pb-6">
            {!! $post->short_content !!}
        </a>
